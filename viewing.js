...
//Creates and array of companies with the necessary data and sets it to the viewer entities
//Adds description, address, and link data.

//Cipher Prime
var companies = [viewer.entities.add({
	  id : 'cipherPrime',
	  name : 'Cipher Prime',
	...
	viewer.entities.add({
	  ...
	  description : '\
		...
		<p>Felt Media is a digital design firm specializing in web and interactive experiences.</p>'
	}),
...
//Creates a list of the companies that have entities within the array "companies"
var listofCompanies = function(){
	for (var i = 0; i < companies.length; i++) {
		$("#newPlaces").append("<li><button type='button' id='" + companies[i]._id + "'>" + companies[i]._name + "</button></li>");
	};
};
